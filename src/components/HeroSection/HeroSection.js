...
const HeroSection = () => {
    return (
        <div
            style={{ backgroundImage: `url("https://marketplace.foodotawp.com/wp-content/uploads/2021/05/two.png")`, backgroundSize: 'cover',  backgroundRepeat: 'no-repeat', height: '70vh', marginTop: "-250px" }}
