...
const HeroSection = () => {
    return (
        <div
            style={{ backgroundImage: `url("https://marketplace.foodotawp.com/wp-content/uploads/2021/05/two.png") `, backgroundRepeat: 'cover', backgroundRepeat: 'no-repeat',  width: "100%", marginTop: "-250px" }}
