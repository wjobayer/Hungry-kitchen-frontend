...
const NewsLetter = () => {
  return (
    <div className="container py-16">
      <div className="bg-black flex md:flex-row flex-col items-center justify-between py-16 rounded-lg px-0 md:px-10 flex-wrap">
        ...
        <div className="grow w-4/5 md:w-3/5 relative">
          ...
          />
          <button className="bg-yellow-500 hover:bg-yellow-400 font-pt_sans absolute py-2 px-5 rounded-full text-white right-1 top-1 bottom-1">
            Subscribe
          </button>
        </div>
      </div>
