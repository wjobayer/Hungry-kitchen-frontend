...
const Header = () => {
  ...
  return (
    <>
      <div className="text-saffron bg-gray-900 text-white">
        <div className="container items-center justify-between hidden py-4 mx-auto lg:flex">
          ...
          <div>
            <span>
              <Link to="tel:654567678">Hotline:(+1) 654 567 – 6789</Link>
            </span>
          </div>
        </div>
      </div>
