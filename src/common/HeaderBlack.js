...

                                {
                                    user.email ?
                                        <div className="flex items-center justify-center py-2 px-4">
                                            ...
                                            href="/login"
                                        >
                                            <NavLink to='/register' className="leading-lg rounded text-black bg-yellow-400 px-5 py-3 hover:bg-transparent hover:outline hover:text-black hover:outline-offset-2 hover:outline-2">
