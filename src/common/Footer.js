          ...
          <div className="grid grid-cols-2">
            <div className="grid grid-cols-3">
              ...
              <div>
                ...
                <p className="mt-5">
                  <a className="font-extrabold" href="/home">
                    Home
                  </a>
                </p>
                <p className="mt-3">
                  <a className="font-extrabold" href="/food">
                    Food
                  </a>
                </p>
                <p className="mt-3">
                  <a className="font-extrabold" href="/resturant">
                    Resturant
                  </a>
                </p>
                <p className="mt-3">
                  <a className="font-extrabold" href="/cart">
                    Cart
                  </a>
                </p>
                <p className="mt-3">
                  <a className="font-extrabold" href="/blog">
                    Blog
                  </a>
                </p>
              </div>
